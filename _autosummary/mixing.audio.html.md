...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`ClipAlignment`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.ClipAlignment)]
* **Returns:**
...
* **Parameters:**
  ...
  * **near_tie_ratio** ([`float`](https://docs.python.org/3/builtins/functions.html#float)) – How close a rival correlation peak must score to a window’s best
    ...
    an older result.
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`AlignedSpan`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.AlignedSpan)]
* **Returns:**
...
* **Parameters:**
  * **bed** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – The audio to be ducked (filepath or [`Audio`](#mixing.audio.Audio)).
...
* **Return type:**
  [`AudioOffset`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.AudioOffset)
* **Returns:**
...
* **Parameters:**
  * **source** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Audio to loop (filepath or [`Audio`](#mixing.audio.Audio)).
...
| [`audio_ops`](mixing.audio.audio_ops.html.md#module-mixing.audio.audio_ops)       | Audio editing via slicing interface.                                                                                    |
|------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| [`audio_util`](mixing.audio.audio_util.html.md#module-mixing.audio.audio_util)     | Audio utility functions.                                                                                                |
| [`beats`](mixing.audio.beats.html.md#module-mixing.audio.beats)               | Beat / downbeat / onset analysis of an audio signal — the `mixing[beats]` primitive.                                    |
| [`segmentation`](mixing.audio.segmentation.html.md#module-mixing.audio.segmentation) | Split a long audio into segments — for example, the individual songs in a concert recording, a DJ mix, or a radio show. |
