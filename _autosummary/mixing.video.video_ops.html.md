...
as [`mixing.audio.overlay_audio()`](mixing.audio.html.md#mixing.audio.overlay_audio)’s `mix_ratio`: the bed plays at
...
* **Parameters:**
  ...
  * **ambient** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path) | [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)) – The ambient/room-tone clip (a path or an `Audio`).
