...
- [`mixing.audio`](mixing.audio.html.md#module-mixing.audio) — sliceable [`Audio`](mixing.audio.html.md#mixing.audio.Audio), fades, crop,
  concat, overlay, alignment, segmentation (needs `pydub`).
- [`mixing.video`](mixing.video.html.md#module-mixing.video) — sliceable `Video`, crop, loop,
  audio replace/normalize, Ken Burns, thumbnails, subtitles (needs `moviepy`
  / `opencv`).
- [`mixing.transcript`](mixing.transcript.html.md#module-mixing.transcript) — speech-to-text (ElevenLabs Scribe, stdlib HTTP),
  filler removal, transcript formats (no heavy deps).
- [`mixing.dubbing`](mixing.dubbing.html.md#module-mixing.dubbing) — text-to-speech re-voicing / translation from SRT.
- [`mixing.srt`](mixing.srt.html.md#module-mixing.srt) — canonical SRT/timeline parsing & formatting (pure).
- [`mixing.chapters`](mixing.chapters.html.md#module-mixing.chapters) — transcript → chapter markers (pure; LLM optional).
...
* **Return type:**
  [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)
* **Returns:**
...
* **Parameters:**
  * **other** ([`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)) – Audio to overlay
...
#### *property* samples *: [AudioSamples](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.AudioSamples)*
...
#### *property* frames *: [VideoFrames](mixing.video.video_ops.html.md#mixing.video.video_ops.VideoFrames)*
...
Bases: [`MixingError`](mixing.errors.html.md#mixing.errors.MixingError), [`ValueError`](https://docs.python.org/3/builtins/exceptions.html#ValueError)

An explicit analysis window leaves a clip no second, independent look.

Raised by [`mixing.audio.align_clips_to_reference()`](mixing.audio.html.md#mixing.audio.align_clips_to_reference) when the caller passes a
...
* **Parameters:**
  * **\*sources** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Audio sources (filepaths or Audio instances)
...
* **Return type:**
  `Union`[[`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path)]
* **Returns:**
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Chapter`](mixing.chapters.html.md#mixing.chapters.Chapter)]
* **Returns:**
...
* **Parameters:**
  ...
  * **srt** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Sequence`](https://docs.python.org/3/library/typing.html#typing.Sequence)[[`Cue`](mixing.srt.html.md#mixing.srt.Cue)]]) – An `.srt` file path, raw SRT text, or a list of [`Cue`](#mixing.Cue).
...
* **Parameters:**
  * **bed** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – The audio to be ducked (filepath or [`Audio`](#mixing.Audio)).
  * **sidechain** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – The audio that triggers ducking — the dialogue track.
...
* **Parameters:**
  * **src** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Audio source (filepath or Audio instance)
  * **duration** ([`float`](https://docs.python.org/3/builtins/functions.html#float)) – Fade duration in seconds
  * **output** (`Union`[[`None`](https://docs.python.org/3/builtins/constants.html#None), [`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`PathLike`](https://docs.python.org/3/library/os.html#os.PathLike)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)], [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)]]) – Where to put the result — None (return the Audio object), a file
    path, a directory (auto-named), or a callable sink. See mixing.egress.
  * **\*\*save_kwargs** – Additional save arguments
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Segment`](mixing.audio.segmentation.html.md#mixing.audio.segmentation.Segment)]
* **Returns:**
...
* **Parameters:**
  ...
  * **output** (`Union`[[`None`](https://docs.python.org/3/builtins/constants.html#None), [`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`PathLike`](https://docs.python.org/3/library/os.html#os.PathLike)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)], [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)]]) – Where to put the film — a file path, a directory (auto-named),
    or a callable sink. See [`mixing.egress`](mixing.egress.html.md#module-mixing.egress). Required.
...
* **Parameters:**
  ...
  * **output** (`Union`[[`None`](https://docs.python.org/3/builtins/constants.html#None), [`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`PathLike`](https://docs.python.org/3/library/os.html#os.PathLike)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)], [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)]]) – Where to put the result — `None` (burns auto-names beside the
    ...
    See [`mixing.egress`](mixing.egress.html.md#module-mixing.egress).
...
* **Parameters:**
  * **source** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Audio to loop (filepath or [`Audio`](#mixing.Audio)).
...
length of `media` ([`mixing.audio.loop_audio()`](mixing.audio.html.md#mixing.audio.loop_audio)), optionally ducked
against the existing dialogue ([`mixing.audio.duck_audio()`](mixing.audio.html.md#mixing.audio.duck_audio)), and mixed
under the existing track ([`mixing.audio.overlay_audio()`](mixing.audio.html.md#mixing.audio.overlay_audio)).
...
[`overlay_audio()`](mixing.audio.html.md#mixing.audio.overlay_audio) — the bed plays at
...
[`duck_audio()`](mixing.audio.html.md#mixing.audio.duck_audio) with the media’s own audio as the
...
* **Parameters:**
  ...
  * **ambient** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path) | [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)) – The ambient/room-tone clip (a path or an [`Audio`](#mixing.Audio)).
...
* **Parameters:**
  * **background** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Background audio (filepath or Audio instance)
  * **overlay** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Audio`](mixing.audio.audio_ops.html.md#mixing.audio.audio_ops.Audio)]) – Audio to overlay (filepath or Audio instance)
  * **position** ([`float`](https://docs.python.org/3/builtins/functions.html#float)) – Position in seconds where overlay starts
...
* **Parameters:**
  ...
  * **style** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`SubtitleStyle`](mixing.video.video_subtitles.html.md#mixing.video.video_subtitles.SubtitleStyle)]) – SubtitleStyle configuration (optional)
...
| [`audio`](mixing.audio.html.md#module-mixing.audio)           | Audio mixing and editing functionality.                                            |
|--------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`chapters`](mixing.chapters.html.md#module-mixing.chapters)     | Detect chapter markers from a transcript — platform-agnostic.                      |
| [`dubbing`](mixing.dubbing.html.md#module-mixing.dubbing)       | Text-to-speech dubbing: re-voice or translate a video from its SRT.                |
| [`egress`](mixing.egress.html.md#module-mixing.egress)         | Canonical *egress*: route a produced result to its destination.                    |
| [`errors`](mixing.errors.html.md#module-mixing.errors)         | Typed errors `mixing` raises — the home for exceptions a caller may want to catch. |
| [`srt`](mixing.srt.html.md#module-mixing.srt)               | Canonical SRT / timeline parsing and formatting (pure, dependency-free).           |
| [`transcript`](mixing.transcript.html.md#module-mixing.transcript) | Transcript-driven media editing.                                                   |
| [`util`](mixing.util.html.md#module-mixing.util)             | General utilities for mixing video, audio, etc.                                    |
| [`video`](mixing.video.html.md#module-mixing.video)           | Video tools                                                                        |
