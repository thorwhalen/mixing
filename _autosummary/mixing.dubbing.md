...
The transcript side of [`mixing`](mixing.md#module-mixing) turns speech into SRT (ElevenLabs
...
**Lazy by design.** Like the top-level [`mixing`](mixing.md#module-mixing) facade, this subpackage
...
* **Parameters:**
  ...
  * **srt** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Path`](https://docs.python.org/3/library/pathlib.html#pathlib.Path), [`Sequence`](https://docs.python.org/3/library/typing.html#typing.Sequence)[[`Cue`](mixing.srt.md#mixing.srt.Cue)]]) – An `.srt` file path, raw SRT text, or a list of [`Cue`](#mixing.dubbing.Cue).
...
| [`dub`](mixing.dubbing.dub.md#module-mixing.dubbing.dub)   | SRT-driven dubbing: replace a video's audio with TTS narration.                                                                     |
|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| [`srt`](mixing.dubbing.srt.md#module-mixing.dubbing.srt)   | SRT translation for dubbing — built on the canonical [`mixing.srt`](mixing.srt.md#module-mixing.srt). |
| [`tts`](mixing.dubbing.tts.md#module-mixing.dubbing.tts)   | ElevenLabs text-to-speech (TTS) HTTP client.                                                                                        |
